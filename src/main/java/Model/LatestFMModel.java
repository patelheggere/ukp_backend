package Model;
	...
	public class LatestFMModel {
		public String ID
		           ...
		           ,ModifiedBy
		           ,DsrOrder
		           ,Code, AreaFormula, VolumeFormula, deductionArea, paintDeductionArea,DsrMainId,IsDsr;
		...
		public LatestFMModel(String iD, String generalInfoID, String structureElementID, String serialNo,
				String itemDescription, String mainLabel, String subLabel, String o, String x, String y, String l,
				String b, String h, String c, String q, String d, String dsrSubID, String uomID, String uomCode,
				String totalArea, String totalVolume, String dSRArea, String dSRVolume, String totalAreaCalculated,
				String totalVolumeCalculated, String copyFromID, String inactive, String createdBy, String modifiedBy,
				String dsrOrder, String code, String areaFormula, String volumeFormula, String deductionArea,
				String paintDeductionArea, String dsrMainId, String isDsr) {
			super();
			ID = iD;
